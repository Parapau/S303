...
public class Decor extends Product {
    ...
    public String ToString() {
        return String.format("  ID:%d Product:Decoration  Price:%.2f    Attribute:%s",super.getIdProduct(), getPrice(), getMaterial() );
    }

    @Override
    public String writeTXT() {
        return super.getIdProduct() + " " + "Decoration" + " " + getPrice() + " " + getMaterial();
    }
}
