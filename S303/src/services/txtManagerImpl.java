...
public class txtManagerImpl implements IDDBBManager{
    ...
    static private final String PATH_TXT_DDBB = "src/resources/txtDDBB.txt";
    static private final String PATH_TXT_maxID = "src/resources/maxID.txt";
    ...
    public void removeProduct(Product product) {
        ...
        int i = 0;
        while ( i != -1 && product.getIdProduct() >= productes.get(i++).getIdProduct()){
