...
public class Menu {
    ...
    private static final IDDBBManager DDBBManager = new txtManagerImpl();
    ...
    public static void RemoveTree(ArrayList<Product>stock){
        ...
        if(index == -1){
            ...
            DDBBManager.removeProduct(product);
            stock.remove(index);
    ...
    public static void NewTicket(ArrayList<Product>stock ,ArrayList<Ticket>sales){
        ...
        //instanciamos un objeto coneccion para guardar el ticket en una base de datos MongoDB
            ...
            switch (text1.toLowerCase()) {
                ...
                case "flor" -> {
                    ...
                    if (index1 == -1) {
                        ...
                        //Eliminamo producto de la DDBB
                        DDBBManager.removeProduct(stock.get(index1));
                        //elimino el producto del stock
                        stock.remove(index1);
                        //aviso que el proceso ocurrió con exito
                ...
                case "decoracion" -> {
                    ...
                    if (index2 == -1) {
                        ...
                        //Eliminamo producto de la DDBB
                        DDBBManager.removeProduct(stock.get(index2));
                        //elimino el producto del stock
                        stock.remove(index2);
                        //aviso que el proceso ocurrió con exito
                        System.out.println("✅Flor agregada al ticket de compra :D");
        ...
        sales.add(ticket);
        MongoConnection.guardarTicketEnDB(ticket);
